...
class Propiedad(models.Model):
    ...
    longitude = models.DecimalField(verbose_name="Longitude", max_digits=25, decimal_places=14)
    latitude = models.DecimalField(verbose_name="Latitude", max_digits=25, decimal_places=7)
