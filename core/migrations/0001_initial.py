# Generated by Django 3.1.5 on 2021-11-23 03:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Propiedad',
            fields=[
                ('id_prop', models.CharField(default='1', max_length=20000, primary_key=True, serialize=False, verbose_name='id')),
                ...
                ('longitude', models.DecimalField(decimal_places=16, max_digits=16, verbose_name='Longitude')),
                ('latitude', models.DecimalField(decimal_places=16, max_digits=16, verbose_name='Latitude')),
