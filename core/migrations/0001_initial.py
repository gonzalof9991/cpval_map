# Generated by Django 3.1.5 on 2021-11-21 21:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_prop', models.CharField(default='1', max_length=20000, verbose_name='id')),
                ...
                ('latitude', models.DecimalField(decimal_places=25, max_digits=25, verbose_name='Latitude')),
